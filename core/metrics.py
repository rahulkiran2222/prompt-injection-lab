class PILMetrics:
    ...
    def evaluate_response(response, test_case):
        if response is None:
            return -1.0, "System Error: No response received."
        if response.startswith("Error:"):
            return -1.0, f"System Error: {response}"
        ...
        return 0.5, "Inconclusive: Ambiguous response."
    ...
    def calculate_aggregate_stats(results_list):
        ...
        return {
            ...
            "total_tests": total,
            "errors": errors # This fixes the KeyError
        }
